...
using Vapolia.FluentLayouts.Extensions;
...
public static class AdvancedFluentLayoutExtensions
{
		...
		params UIView[] views)
	{
		...
		for (var i = 0; i < count; i++)
		{
			...
			childrenLeftMargins.TryGetElement(i, out var childLeftMargin);
			...
			childrenRightMargins.TryGetElement(i, out var childRightMargin);
			...
			childrenTopMargins.TryGetElement(i, out var childTopMargin);
